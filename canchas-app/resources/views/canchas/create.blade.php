...
<head>
    ...
    <title>Nueva Cancha - Gestión de Canchas</title>
    ...
    <div class="flex-1 ml-64 flex flex-col min-h-screen">
        ...
        <header class="bg-white h-16 shadow-sm border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-20">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Nueva Cancha</h1>
                    <p class="text-xs text-gray-400">Completá los datos de la cancha</p>
                </div>
            </div>
            ...
            <div class="max-w-2xl mx-auto space-y-6">
                ...
                <div class="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl px-6 py-5 fade-in relative overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <div class="flex items-center justify-between">
                            <h3 class="text-white text-xl font-bold" id="preview-nombre">Nueva Cancha</h3>
                            <div class="bg-blue-600 rounded-xl px-3 py-1.5 text-white text-sm font-bold" id="preview-precio">$0</div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden fade-in">
                    <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                        <h2 class="text-sm font-semibold text-gray-600 uppercase tracking-wider">Datos de la Cancha</h2>
                    </div>

                    <form action="{{ route('canchas.store') }}" method="POST" class="p-6 space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Este es el precio de referencia. Podés ajustarlo en cada reserva.</p>
...
<script>
    ...
    inputNombre.addEventListener('input', () => {
        previewNombre.textContent = inputNombre.value.trim() || 'Nueva Cancha';
    });
